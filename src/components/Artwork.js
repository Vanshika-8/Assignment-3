...
import {AddItemsContext} from './contextArtWork';


const ArtWork=(props)=> {
    const {currentId,showSuccessSnackbar,addToCart,snackBar,settingTimeOut}=useContext(AddItemsContext)
